...
class Administracao::DepartamentosController < ApplicationController
   ...
   def administracao_departamento_params
      params.require(:administracao_departamento).permit(:nome, :sigla, :nome_responsavel, :descricao, :entidade_id, :responsavel_id, :e_um_destino, :usa_moto,endereco_attributes: [:logradouro, :numero, :complemento, :estado_id, :cidade_id, :bairro_id, :cep, :endereco, :latitude, :longitude])
   end

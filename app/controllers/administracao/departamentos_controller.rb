class Administracao::DepartamentosController < ApplicationController
  ...
  private
    ...
    def administracao_departamento_params
      params.require(:administracao_departamento).permit(:nome,:nome_responsavel, :descricao, :entidade_id, :responsavel_id, endereco_attributes: [:logradouro,:numero,:complemento,:estado_id,:cidade_id,:bairro_id,:cep,:endereco,:latitude,:longitude])
    end
